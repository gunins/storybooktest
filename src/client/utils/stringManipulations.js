...
const commonWords = [
    ...
    "the", "their", "them", "then", "there", "these", "they", "this", "tis", "to", "too", "twas", "us", "wants", "was",
    "we", "were", "what", "when", "where", "which", "while", "who", "whom", "why", "will", "with", "would", "yet",
    "you", "your", "ain't", "aren't", "can't", "could've", "couldn't", "didn't", "doesn't", "don't", "hasn't", "he'd",
    "he'll", "he's", "how'd", "how'll", "how's", "i'd", "i'll", "i'm", "i've", "isn't", "it's", "might've", "mightn't",
    "must've", "mustn't", "shan't", "she'd", "she'll", "she's", "should've", "shouldn't", "that'll", "that's", "there's",
...
const stripString = string => (string || '').replace(/[^\w']+/g, ' ').replace(/\s{2,}/g, ' ').trim();

const toLowerCase = (string) => stripString(string).toLowerCase();

const splitToArray = string => uniqueArray(toLowerCase(string).split(' ')).filter(word => commonWords.indexOf(word) === -1);


export {splitToArray, stripString, toLowerCase};